...
ReHealth is a Python-based desktop health tracking application that allows users to manage their fitness metrics,
measurements, and health data. The application features user authentication, a dashboard interface, and measurement
